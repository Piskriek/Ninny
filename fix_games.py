...
target1 = """function roundBadge(current, total) {
  return}
...
replace1 = """function roundBadge(current, total) {
...
target2 = """    }
 ...
 (do not replace this line, we inject before it)
"""
...
if target1_norm not in content_norm:
    print("WARNING: target1 not found!")
if target2_norm not in content_norm:
    print("WARNING: target2 not found!")

new_content = content_norm.replace(target1_norm, replace1).replace(target2_norm, replace2)
