...
const WEEKLY = {
    ...
    monday: {
        ...
        guardianTips: {
            weather: { intro: 'Start the week gently. Ask her what she is looking forward to this week.', steps: ['Discuss the weather together — look outside.', 'Ask: "What day is it? What comes after Monday?"', 'Share one thing YOU are looking forward to this week.', 'Ask how she slept and how she feels.', 'Draw the weather in a notebook — start a weekly weather chart!'], extend: ["Play 'Weather Reporter' - give them a spoon as a microphone and let them report.", "Draw a 'Weather House' showing what clothes to wear in different rooms.", "Talk about extreme weather: 'What is a tornado? What is a blizzard?'", "Make a weather chart that they can update every single morning.", "Learn a weather song together on YouTube."] },
            sculptor: { intro: 'Introduce the week\'s theme through art.', steps: ['Roll clay/playdough into a ball TOGETHER.', 'Ask: "What shape is this? Can we make it flat?"', 'Give her the theme: Draw the flag of a place you want to visit.', 'Name each colour as she picks it up.', 'Ask her to show you something round, then something with corners.'], extend: ["Trade artworks and try to add one missing detail to each other's drawings.", "Only use your non-dominant hand to draw the next picture.", "Try drawing with your eyes closed and guess what it is!", "Sculpt the alphabet letters out of the playdough.", "Create a story where your sculpted characters come to life."] },
            obstacle: { intro: 'Get the body awake after the weekend!', steps: ['Do 10 jumping jacks TOGETHER before starting the screen game.', 'Use real furniture: jump over a pillow, crawl under a table.', 'Ask: "What is OVER the table?" and "What is UNDER the chair?"', 'Time her and let her try to beat her score.', 'Teach the word "beside" — put two objects beside each other.'], extend: ["Do the entire obstacle course backwards!", "Balance a book on your head while navigating the course.", "Time the course and see if they can beat their own record by 3 seconds.", "Have them verbally describe their movements ('I am jumping OVER the pillow').", "Freeze like a statue every time you clap your hands during the course."] },
            scavenger: { intro: 'Focus on A–E sounds only today.', steps: ['"A" is for Apple — find ANYTHING that starts with A!', '"B" is for Ball — clap when you name a B word.', '"C" is for Cat — can she find 3 C words?', 'Write the letters A–E on paper and she decorates each one.', 'Say a word and she must guess the first letter.'], extend: ["Find objects that are only a specific color as well as starting with the letter.", "Make a pile of the found objects and sort them from smallest to largest.", "Have them blindfold you and guide your hand to touch the found objects.", "Create a silly sentence using only the objects you found.", "Hide the objects again and make a treasure map to find them."] },
            charades: { intro: 'Monday energy is high — use it for big movement!', steps: ['You act an animal first, she guesses.', 'She picks an animal card, acts it, you guess.', 'After each animal: "Where does this animal live?"', 'SA focus: Lion and Elephant are game animals — are they dangerous?', 'Sing "Old MacDonald" together substituting SA animals.'], extend: ["Do the charades in slow motion.", "Only use facial expressions, absolutely no hand movements.", "Act out an animal waking up in the morning.", "Try acting out two animals at the exact same time (a flying elephant!).", "Have them teach YOU a new animal charade you've never seen."] },
            suitcase: { intro: 'Recap the WHOLE day together — this is the most important 15 minutes.', steps: ['Ask her to pick the 3 best things from today.', 'For each: "Tell me one thing you learned about that."', 'Ask: "What was HARD today? What was EASY?"', 'Ask: "What do you want to do tomorrow?"', 'Help her call Dad/Grandma and tell them ONE thing from today.'], extend: ["Recall events in reverse order: what happened LAST before what happened FIRST?", "Ask them to teach a toy what they learned today.", "Draw the best part of the day using only three colors.", "Sing a recap of the day to the tune of 'Twinkle Twinkle'.", "Ask what they would change about today if they had a magic wand."] },
        },
    },
    ...
    wednesday: {
        ...
        guardianTips: {
            weather: { intro: 'Science day — everything is an experiment!', steps: ['Go outside for 2 minutes and observe the weather together.', 'Feel the air: "Is it humid? Dry? Can you smell rain?"', 'Ask: "What do YOU think the weather will be tomorrow?"', 'Look at clouds together — name their shapes.', 'Start a "Weather diary" — she draws tomorrow\'s prediction.'], extend: ["Play 'Weather Reporter' - give them a spoon as a microphone and let them report.", "Draw a 'Weather House' showing what clothes to wear in different rooms.", "Talk about extreme weather: 'What is a tornado? What is a blizzard?'", "Make a weather chart that they can update every single morning.", "Learn a weather song together on YouTube."] },
            sculptor: { intro: 'Nature sensory play.', steps: ['Collect 5 items from outside: leaf, stick, pebble, flower, soil.', 'Feel each one: "Is it smooth, rough, soft, hard?"', 'Use the items to make a nature COLLAGE on paper with glue.', 'Ask: "Where does this come from? Is it from a plant or an animal?"', 'Sort the items by size, colour, or texture.'], extend: ["Trade artworks and try to add one missing detail to each other's drawings.", "Only use your non-dominant hand to draw the next picture.", "Try drawing with your eyes closed and guess what it is!", "Sculpt the alphabet letters out of the playdough.", "Create a story where your sculpted characters come to life."] },
            obstacle: { intro: 'Explorer movement circuit.', steps: ['Pretend to be a scientist on a nature trek.', 'Ask: "What is a mountain? Can you climb like you\'re on a mountain?"', 'Find something NEXT TO the wall, something BEHIND the door.', 'Ask: "Is the sun ABOVE us or BELOW us?"', 'Measure things using her foot as a "unit" — how many feet long is the couch?'], extend: ["Do the entire obstacle course backwards!", "Balance a book on your head while navigating the course.", "Time the course and see if they can beat their own record by 3 seconds.", "Have them verbally describe their movements ('I am jumping OVER the pillow').", "Freeze like a statue every time you clap your hands during the course."] },
            scavenger: { intro: 'K-O sounds today — connect to nature.', steps: ['"K" is for Kite — what shape is a kite, and what does it DO?', '"L" is for Lion — describe what a Lion looks like without naming it.', '"M" is for Moon — is the moon out at night or during the day? Why?', '"N" is for Nest — what animals live in nests?', '"O" is for Octopus — how many arms does it have? Count to 8 together!'], extend: ["Find objects that are only a specific color as well as starting with the letter.", "Make a pile of the found objects and sort them from smallest to largest.", "Have them blindfold you and guide your hand to touch the found objects.", "Create a silly sentence using only the objects you found.", "Hide the objects again and make a treasure map to find them."] },
            charades: { intro: 'Water animals and wild beasts today.', steps: ['Hippo: blow bubbles in a cup of water together.', 'Crocodile: snap your arms like jaws in slow motion.', 'Frog: jump across the room counting how many jumps.', 'Fish: "swim" across the floor on your tummies.', 'Ask: "Which of these animals can swim? Which can\'t?"'], extend: ["Do the charades in slow motion.", "Only use facial expressions, absolutely no hand movements.", "Act out an animal waking up in the morning.", "Try acting out two animals at the exact same time (a flying elephant!).", "Have them teach YOU a new animal charade you've never seen."] },
            suitcase: { intro: 'Wednesday is halfway through the week — great time to reflect!', steps: ['Ask: "What is the most interesting thing you discovered this week so far?"', 'Ask: "What does a scientist DO?"', 'Play "I Spy" with nature words: "I spy something that is green and has leaves."', 'Ask her to explain ONE thing she learned to a toy or teddy.', 'Draw a "brain map" together — what\'s inside her head after this week?'], extend: ["Recall events in reverse order: what happened LAST before what happened FIRST?", "Ask them to teach a toy what they learned today.", "Draw the best part of the day using only three colors.", "Sing a recap of the day to the tune of 'Twinkle Twinkle'.", "Ask what they would change about today if they had a magic wand."] },
        },
    },
    ...
    thursday: {
        ...
        guardianTips: {
            weather: { intro: 'High energy day — match her enthusiasm!', steps: ['Do a "weather workout" — sunny = jumping jacks, rainy = running on the spot.', 'Ask: "What sport could you play in this weather?"', 'Ask: "What does your body feel like before exercise vs after?"', 'Name a sport: she must act it out.', 'Ask: "How many jumping jacks can you do before you need to breathe?"'], extend: ["Play 'Weather Reporter' - give them a spoon as a microphone and let them report.", "Draw a 'Weather House' showing what clothes to wear in different rooms.", "Talk about extreme weather: 'What is a tornado? What is a blizzard?'", "Make a weather chart that they can update every single morning.", "Learn a weather song together on YouTube."] },
            sculptor: { intro: 'Body awareness through art.', steps: ['Trace her hand and she decorates it with patterns.', 'Ask: "How many fingers? How many knuckles?"', 'Draw a superhero body together — where are the muscles?', 'Talk about body parts: "What does your heart do? Your lungs?"', 'Ask her to draw what she looks like when she\'s running.'], extend: ["Trade artworks and try to add one missing detail to each other's drawings.", "Only use your non-dominant hand to draw the next picture.", "Try drawing with your eyes closed and guess what it is!", "Sculpt the alphabet letters out of the playdough.", "Create a story where your sculpted characters come to life."] },
            obstacle: { intro: 'Maximum movement today!', steps: ['Time the course three times — can she beat her record?', 'Add a new obstacle each round: balance beam (tape on floor), tunnel (blanket over chairs).', 'Use FULL spatial language: "Go THROUGH the tunnel, then AROUND the pillow."', 'Ask: "Which is more tiring — going OVER or going UNDER?"', 'Count her steps between each obstacle.'], extend: ["Do the entire obstacle course backwards!", "Balance a book on your head while navigating the course.", "Time the course and see if they can beat their own record by 3 seconds.", "Have them verbally describe their movements ('I am jumping OVER the pillow').", "Freeze like a statue every time you clap your hands during the course."] },
            scavenger: { intro: 'P-T sounds — energetic connections!', steps: ['"P" is for Penguin — waddle across the room!', '"Q" is for Queen — sit very still and tall like royalty.', '"R" is for Run — how fast can she spell R-U-N while running on the spot?', '"S" is for Star — do star jumps while you call out S words.', '"T" is for Turtle — who can move slowest across the room?'], extend: ["Find objects that are only a specific color as well as starting with the letter.", "Make a pile of the found objects and sort them from smallest to largest.", "Have them blindfold you and guide your hand to touch the found objects.", "Create a silly sentence using only the objects you found.", "Hide the objects again and make a treasure map to find them."] },
            charades: { intro: 'Speed and strength theme today.', steps: ['Cheetah: sprint across the room and FREEZE when you shout stop.', 'Springbok: pronk (leap with all 4 limbs) — try it together!', 'Play "Freeze Dance" — music on, she dances; music off, she freezes as an animal.', 'Count "who can hold the stillest pose longest" — guardian vs child.', 'Silly round: be a SLOW cheetah, a TINY elephant.'], extend: ["Do the charades in slow motion.", "Only use facial expressions, absolutely no hand movements.", "Act out an animal waking up in the morning.", "Try acting out two animals at the exact same time (a flying elephant!).", "Have them teach YOU a new animal charade you've never seen."] },
            suitcase: { intro: 'Body-themed recap.', steps: ['Ask: "Which part of your body worked the hardest today?"', 'Ask: "Can you touch your toes? Your elbow? Your funny bone?"', 'Play "Simon Says" with body parts.', 'Ask: "What do you eat to make your body strong?"', 'Talk about sleep: "Your body grows when you sleep! How many hours did you sleep?"'], extend: ["Recall events in reverse order: what happened LAST before what happened FIRST?", "Ask them to teach a toy what they learned today.", "Draw the best part of the day using only three colors.", "Sing a recap of the day to the tune of 'Twinkle Twinkle'.", "Ask what they would change about today if they had a magic wand."] },
        },
    },
    ...
    friday: {
        ...
        guardianTips: {
            weather: { intro: 'Friday is celebratory — big smiles and high fives all morning!', steps: ['Do a "week in review" — name one thing for each day of the week.', 'Make a special morning drink together (hot chocolate, smoothie).', 'Ask: "What SEASON is it? What months are in this season?"', 'Talk about the weekend — what is the plan?', 'Give her 3 genuine compliments about her work THIS WEEK.'], extend: ["Play 'Weather Reporter' - give them a spoon as a microphone and let them report.", "Draw a 'Weather House' showing what clothes to wear in different rooms.", "Talk about extreme weather: 'What is a tornado? What is a blizzard?'", "Make a weather chart that they can update every single morning.", "Learn a weather song together on YouTube."] },
            ...
            obstacle: { intro: 'Championship day — go all out!', steps: ['Build the BIGGEST obstacle course yet — use EVERY room.', 'Let her design the course — she places the obstacles.', 'Invite a sibling, pet, or teddy to "compete."', 'Give out a certificate at the end (draw one on paper!).', 'Ask: "What new obstacle would you add if you could?"'], extend: ["Trade artworks and try to add one missing detail to each other's drawings.", "Only use your non-dominant hand to draw the next picture.", "Try drawing with your eyes closed and guess what it is!", "Sculpt the alphabet letters out of the playdough.", "Create a story where your sculpted characters come to life."] },
            scavenger: { intro: 'Final letters of the alphabet!', steps: ['U,V,W,X,Y,Z are tricky — make it silly and playful.', 'X challenge: name ONE X word (X-ray, xylophone) and act it out.', 'Z challenge: ZAP everything you touch for 1 minute!', 'Sing the full alphabet song together, clapping on every letter.', 'Test RANDOM letters — she has 3 seconds to name the word!'], extend: ["Find objects that are only a specific color as well as starting with the letter.", "Make a pile of the found objects and sort them from smallest to largest.", "Have them blindfold you and guide your hand to touch the found objects.", "Create a silly sentence using only the objects you found.", "Hide the objects again and make a treasure map to find them."] },
            charades: { intro: 'SA Animal PARADE — biggest game of the week!', steps: ['Everyone in the family gets an animal.', 'Make a "parade" — march around the room in character.', 'Play the "freeze" game with ALL the SA animals.', 'Nature quiz: "Which is bigger — an elephant or a hippo?"', 'Award "Animal of the Week" — she picks her favourite SA animal and draws it.'], extend: ["Do the charades in slow motion.", "Only use facial expressions, absolutely no hand movements.", "Act out an animal waking up in the morning.", "Try acting out two animals at the exact same time (a flying elephant!).", "Have them teach YOU a new animal charade you've never seen."] },
            suitcase: { intro: 'FULL WEEK recap — this moment is golden.', steps: ['She tells you ONE thing from each day: Monday, Tuesday, Wednesday, Thursday, Friday.', 'Ask: "Which day was your favourite? Why?"', 'Ask: "What was the hardest thing you did?"', 'Ask: "What do you want to learn NEXT week?"', 'Celebrate with a small reward — a sticker, an extra story, or 20 minutes of her favourite show.'], extend: ["Recall events in reverse order: what happened LAST before what happened FIRST?", "Ask them to teach a toy what they learned today.", "Draw the best part of the day using only three colors.", "Sing a recap of the day to the tune of 'Twinkle Twinkle'.", "Ask what they would change about today if they had a magic wand."] },
        },
    },
};
